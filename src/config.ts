...
const configuration: any = {
  ...
  dischargereasons: ["ABS: Abscond", "Disch:Discharg", "Ref: Referral", "LAMA:Leave Against Medical Advice"],
  dischargereasonoptions: ["ABS", "Disch", "Ref", "LAMA", "ABS: Abscond", "Disch:Discharg", "Ref: Referral", "LAMA:Leave Against Medical Advice"],
