...
const paediatrics = new mongoose_1.Schema({
    immunizationhistory: {
        immunization: String,
        hepb0: String,
        opv0: String,
...
const physicalexaminationSchema = new mongoose_1.Schema({
    cvs: {
        heartrate: String,
        bpsystolic: String,
        bpdiastolic: String,
...
const generalphysicalexaminationSchema = new mongoose_1.Schema({
    hair: String,
    hairnote: String,
    face: String,
    facenote: String,
